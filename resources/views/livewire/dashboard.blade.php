<div class="py-10 px-6 max-w-7xl mx-auto font-[Poppins]">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-300">
            ...
            @if($esJefe)
                <div class="relative w-fit max-w-[12rem]">
    ...
    <div class="flex gap-4 mb-6">
        <a href="#"
           class="bg-[#5B3CF1] hover:bg-[#472cd5] text-white px-4 py-2 rounded shadow text-sm">
            + Nuevo pedido
        </a>
        <a href="#"
           class="bg-[#5B3CF1] hover:bg-[#472cd5] text-white px-4 py-2 rounded shadow text-sm">
    ...
    <script>
        ...
        window.addEventListener('sucursal-cambiada', () => {
            ...
            document.body.style.pointerEvents = 'none'; // ⚠️ Previene clics

            // Forzamos recarga completa desde el navegador
